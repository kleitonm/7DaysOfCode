...
class DetailsViewController: UIViewController {
    ...
    private func getDetails() {
        ...
        scoreLabel.attributedText = NSAttributedString(string: movie.overview).withLineSpacing(8.0)
    }
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            scoreLabel.topAnchor.constraint(equalTo: subTitlelabel.bottomAnchor, constant: 32.0),
            scoreLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16.0),
            scoreLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16.0),
        ])
    }
